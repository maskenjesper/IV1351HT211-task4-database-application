...
SELECT lessons_pivoted.month, COALESCE(lessons_pivoted.individual,0) AS individual, COALESCE(lessons_pivoted.group,0) AS group ,COALESCE(lessons_pivoted.ensamble,0) AS ensamble, total
